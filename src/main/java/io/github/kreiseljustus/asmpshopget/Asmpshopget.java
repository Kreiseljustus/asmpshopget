...
public class Asmpshopget implements ModInitializer {
    ...
    //Only here for season start
    boolean season3Message = false;
    ...
    public void onClientTick(MinecraftClient client) {
        ...
        //Only here for season 3 start
        if(tickInServer % 6000 == 0 && !season3Message && s_Config.enable) {
            try {
                if(!VersionManagment.season3Start()) {
                    s_Player.sendMessage(Text.of("Data collection for Season 3 has not started yet!"), false);
